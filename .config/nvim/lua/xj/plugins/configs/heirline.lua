return function(_, opts)
  ...
  local C = require("xj.core.utils.status.env").fallback_colors
  local get_hlgroup = require("xj.core.utils").get_hlgroup
  local lualine_mode = require("xj.core.utils.status.hl").lualine_mode
  ...
  local function setup_colors()
    ...
    local colors = xj.user_opts("heirline.colors", {
      close_fg = Error.fg,
      fg = StatusLine.fg,
      bg = StatusLine.bg,
      ...
      buffer_active_close_fg = Normal.fg,
      ...
      buffer_overflow_fg = TabLine.fg,
      buffer_overflow_bg = TabLineFill.bg,
      buffer_picker_fg = Error.fg,
      tab_close_fg = TabLine.fg,
