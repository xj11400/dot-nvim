...
return {
    ...
    config = function()
        require('gitsigns').setup(vim.tbl_deep_extend('force', {
            ...
            on_attach = function(bufnr)
                ...
                map({
                    'n',
                    'v'
                }, '<leader>vs', ':Gitsigns stage_hunk<CR>', {
                    desc = 'Stage hunk'
                })
                map({
                    'n',
                    'v'
                }, '<leader>vr', ':Gitsigns reset_hunk<CR>', {
                    desc = 'Reset hunk'
                })
        ...
        }, conf.plugins.gitsigns or {}))
    end,
    enabled = not vim.tbl_contains(conf.disable_builtin_plugins, 'gitsigns')
}
