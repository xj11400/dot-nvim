...
return {
  ...
  },
  {
    ...
    init = function() xj.lsp.skip_setup = utils.list_insert_unique(xj.lsp.skip_setup, "tsserver") end,
    ft = {
      "typescript",
      "typescriptreact",
      "javascript",
    ...
    opts = function() return { server = require("xj.core.utils.lsp").config "tsserver" } end,
  },
  {
