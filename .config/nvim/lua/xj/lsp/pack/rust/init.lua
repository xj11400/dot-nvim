...
return {
  ...
  },
  {
    ...
    ft = { "rust" },
    init = function() xj.lsp.skip_setup = utils.list_insert_unique(xj.lsp.skip_setup, "rust_analyzer") end,
    opts = function()
      local adapter
      ...
      return { server = require("xj.core.utils.lsp").config "rust_analyzer", dap = { adapter = adapter } }
    end,
    dependencies = {
      {
