...
local Config = require "xj.colors.theme.onedarker.lua.onedarker.config"
local C = require "xj.colors.theme.onedarker.lua.onedarker.palette"
...
function M.setup()
  local Treesitter = require "xj.colors.theme.onedarker.lua.onedarker.highlights.Treesitter"
  local markdown = require "xj.colors.theme.onedarker.lua.onedarker.highlights.markdown"
  local Whichkey = require "xj.colors.theme.onedarker.lua.onedarker.highlights.Whichkey"
  local Notify = require "xj.colors.theme.onedarker.lua.onedarker.highlights.Notify"
  local Git = require "xj.colors.theme.onedarker.lua.onedarker.highlights.Git"
  local LSP = require "xj.colors.theme.onedarker.lua.onedarker.highlights.LSP"
  local Diff = require "xj.colors.theme.onedarker.lua.onedarker.highlights.Diff"
