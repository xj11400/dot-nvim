...
--
-- This module can be loaded with `local ui = require("xj.core.utils.ui")`
--
-- @module xj.core.utils.ui
-- @see xj.core.utils
-- @copyright 2022
...
local function ui_notify(silent, ...) return not silent and require("xj.core.utils").notify(...) end

--- Toggle notifications for UI toggles
---@param silent? boolean if true then don't sent a notification
function M.toggle_ui_notifications(silent) -- TODO: rename to toggle_notifications in XXXNvim v4
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("xj.core.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
-- TODO: remove old function name in XXXNvim v4
...
function M.toggle_url_match(silent)
  ...
  require("xj.core.utils").set_url_match()
