--- ### XXXNvim Status Conditions
--
-- Statusline related condition functions to use with Heirline
--
-- This module can be loaded with `local condition = require "xj.core.utils.status.condition"`
--
-- @module xj.core.utils.status.condition
-- @copyright 2023
...
function M.lsp_attached(bufnr)
  ...
  return package.loaded["xj.core.utils.lsp"] and next(vim.lsp.get_active_clients { bufnr = bufnr or 0 }) ~= nil
end
