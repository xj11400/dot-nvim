--- ### XXXNvim Status Heirline Extensions
--
-- Statusline related heirline specific extensions
--
-- This module can be loaded with `local xj_heirline = require "xj.core.utils.status.heirline"`
--
-- @module xj.core.utils.status.heirline
-- @copyright 2023
