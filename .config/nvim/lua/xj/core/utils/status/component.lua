--- ### XXXNvim Status Components
--
-- Statusline related component functions to use with Heirline
--
-- This module can be loaded with `local component = require "xj.core.utils.status.component"`
--
-- @module xj.core.utils.status.component
-- @copyright 2023
...
local hl = require "xj.core.utils.status.hl"
local init = require "xj.core.utils.status.init"
local provider = require "xj.core.utils.status.provider"
