--- ### XXXNvim Status Environment
--
-- Statusline related environment variables shared between components/providers/etc.
--
-- This module can be loaded with `local env = require "xj.core.utils.status.env"`
--
-- @module xj.core.utils.status.env
-- @copyright 2023
...
M.separators = xj.user_opts("heirline.separators", {
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = xj.user_opts("heirline.attributes", {
...
M.icon_highlights = xj.user_opts("heirline.icon_highlights", {
  file_icon = {
...
M.sign_handlers = xj.user_opts("heirline.sign_handlers", M.sign_handlers)
