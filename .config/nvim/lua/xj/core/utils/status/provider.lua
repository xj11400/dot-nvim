--- ### XXXNvim Status Providers
--
-- Statusline related provider functions for building statusline components
--
-- This module can be loaded with `local provider = require "xj.core.utils.status.provider"`
--
-- @module xj.core.utils.status.provider
-- @copyright 2023
-- @license GNU General Public License v3.0

local M = {}

local condition = require "xj.core.utils.status.condition"
local env = require "xj.core.utils.status.env"
local status_utils = require "xj.core.utils.status.utils"
...
-- @usage local heirline_component = { provider = require("xj.core.utils.status").provider.file_encoding() }
-- @see xj.core.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("xj.core.utils.status").provider.file_format() }
-- @see xj.core.utils.status.utils.stylize
...
function M.lsp_progress(opts)
  ...
  return function()
    local _, Lsp = next(xj.lsp.progress)
