--- ### Git LUA API
--
-- This module can be loaded with `local git = require "xj.core.utils.git"`
--
-- @module xj.core.utils.git
-- @copyright 2022
...
--- Run a git command from the XXXNvim installation directory
---@param args string|string[] the git arguments
---@return string|nil # The result of the command or nil if unsuccessful
function git.cmd(args, ...)
  if type(args) == "string" then args = { args } end
  return require("xj.core.utils").cmd(vim.list_extend({ "git", "-C", xj.install.home }, args), ...)
end
...
--- Check if the XXXNvim is able to reach the `git` command
...
--- Check if the XXXNvim home is a git repo
...
---@return string|nil # The branch of the XXXNvim installation
...
---@param commits string[] an array like table of commit messages
---@return string[][] # An array like table of echo messages to provide to nvim_echo or xj.echo
