--- ### Mason Utils
--
-- Mason related utility functions to use within XXXNvim and user configurations.
--
-- This module can be loaded with `local mason_utils = require("xj.core.utils.mason")`
--
-- @module xj.core.utils.mason
-- @see xj.core.utils
-- @copyright 2022
